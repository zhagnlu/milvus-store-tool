...
class GcpChunkManagerTest : public testing::Test
{
public:
    GcpChunkManagerTest()
    {
...
TEST_F(GcpChunkManagerTest, WritePositive)
{
...
TEST_F(GcpChunkManagerTest, ReadPositive)
{
    string testBucketName = config_.bucket_name;
    chunk_manager_->SetBucketName(testBucketName);
    EXPECT_EQ(chunk_manager_->GetBucketName(), testBucketName);
...
TEST_F(GcpChunkManagerTest, RemovePositive)
{
    string testBucketName = config_.bucket_name;
    chunk_manager_->SetBucketName(testBucketName);
    EXPECT_EQ(chunk_manager_->GetBucketName(), testBucketName);
...
TEST_F(GcpChunkManagerTest, ListWithPrefixPositive)
{
    string testBucketName = config_.bucket_name;
    chunk_manager_->SetBucketName(testBucketName);
    EXPECT_EQ(chunk_manager_->GetBucketName(), testBucketName);
