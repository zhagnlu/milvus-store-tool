...
class OssChunkManagerTest : public testing::Test
{
public:
    OssChunkManagerTest()
    {
...
TEST_F(OssChunkManagerTest, WritePositive)
{
...
TEST_F(OssChunkManagerTest, ReadPositive)
{
    string testBucketName = config_.bucket_name;
    chunk_manager_->SetBucketName(testBucketName);
    EXPECT_EQ(chunk_manager_->GetBucketName(), testBucketName);
...
TEST_F(OssChunkManagerTest, RemovePositive)
{
    string testBucketName = config_.bucket_name;
    chunk_manager_->SetBucketName(testBucketName);
    EXPECT_EQ(chunk_manager_->GetBucketName(), testBucketName);
...
TEST_F(OssChunkManagerTest, ListWithPrefixPositive)
{
    string testBucketName = config_.bucket_name;
    chunk_manager_->SetBucketName(testBucketName);
    EXPECT_EQ(chunk_manager_->GetBucketName(), testBucketName);
    ...
    vector<string> objs = chunk_manager_->ListWithPrefix("1");
